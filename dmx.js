...
DMX.prototype.addUniverse = function (name, driver, deviceId, options) {
...
DMX.prototype.universeToObject = function (universe) {
  var myUniverse = this.universes[universe]
  var u = {}
  for (var i = 0; i < (myUniverse.channels || 512); i++) {
    u[i] = myUniverse.get(i)
  }
  return u
}
